...
function mapStateToProps(state) {
    ...
    const { loggingIn } = authentication ? authentication : false;
    return {
        loggingIn
    };
}

const connectedTestLoginPage = connect(mapStateToProps)(LoginPage);
export { connectedTestLoginPage as TestLoginPage };
